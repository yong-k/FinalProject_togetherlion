...
<script type="<%=cp%>/text/javascript"
			...
			<nav class="sb-sidenav accordion sb-sidenav-light"
				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						<div class="collapse show" id="homepage"
							aria-labelledby="headingThree" data-bs-parent="#sidenavAccordion">
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="admin_homepage_noticeList.jsp">공지사항</a>
								<a class="nav-link current-menu"
									href="admin_homepage_categoryList.jsp">카테고리</a> <a
									class="nav-link" href="admin_homepage_mannerLevelList.jsp">매너지수</a>
							</nav>
						</div>
						<a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
					...
					<div class="card mb-4">
						...
						<div class="category-list">
							<div class="card-body reportReason-card-body">
								<table
									class="table table-hover table-borderless reportReason-table">
									<thead>
										<tr>
											<th colspan="2"><i class="fa-solid fa-kitchen-set"></i>카테고리
											</th>
										</tr>
									</thead>
									<tbody>
										<c:forEach var="cate" items="${list }">
											...
											<c:forEach var="subCate" items="${sub }">
											<c:if test="${cate.code == subCate.main_cate_code }">
												<tr>
													<td></td>
													<td>- ${subCate.name }</td>
												</tr>
